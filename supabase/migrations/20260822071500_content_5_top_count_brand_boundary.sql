...
-- CONTENT-5 exposed that the original TOP-N parser treated a branded token such
-- as "TOP500" as an author promise for 500 entries. Public ranking titles use
-- an explicit spaced form ("TOP 5", "TOP 3", ...), so only that form is an
-- editorial count promise. All other OPS-1 readiness checks remain unchanged.
