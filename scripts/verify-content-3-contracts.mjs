...
const actorIndex = read('supabase/migrations/20260819030200_content_3_actor_fk_index.sql')
...
expect(actorIndex.includes('CREATE INDEX idx_ranking_revalidations_actor') && actorIndex.includes('ON public.ranking_revalidations(actor_id)'), 'CONTENT-3 actor foreign key must have a covering index')
