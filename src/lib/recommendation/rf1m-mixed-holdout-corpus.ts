...
function slug(value: string) {
  const normalized = value
    ...
    .replace(/[^\p{L}\p{N}]+/gu, '-')
    .replace(/^-+|-+$/g, '')
  return `${normalized || 'value'}-${hash32(value).toString(16).padStart(8, '0')}`
}
...
const WORLDS: HoldoutWorld[] = [
  ...
  {
    key: 'football-clubs', category: 'sports', label: '유럽 축구 클럽',
  ...
  {
    key: 'national-economies', category: 'economy', label: '국가 경제',
  ...
  {
    key: 'smartphones', category: 'technology', label: '플래그십 스마트폰',
  ...
  {
    key: 'laptops', category: 'technology', label: '프리미엄 노트북',
  ...
  {
    key: 'mirrorless-cameras', category: 'technology', label: '미러리스 카메라',
  ...
  {
    key: 'electric-cars', category: 'mobility', label: '전기차',
  ...
  {
    key: 'airlines', category: 'travel', label: '항공사',
  ...
  {
    key: 'movies', category: 'media', label: '영화',
  ...
  {
    key: 'video-games', category: 'media', label: '비디오 게임',
  ...
  {
    key: 'restaurants', category: 'local', label: '도심 레스토랑',
  ...
  {
    key: 'coffee-shops', category: 'local', label: '카페',
  ...
  {
    key: 'hiking-trails', category: 'outdoors', label: '하이킹 코스',
  ...
  {
    key: 'running-shoes', category: 'sports', label: '러닝화',
  ...
  {
    key: 'skincare-products', category: 'beauty', label: '스킨케어 제품',
  ...
  {
    key: 'mechanical-keyboards', category: 'technology', label: '기계식 키보드',
  ...
  {
    key: 'marketplaces', category: 'commerce', label: '온라인 마켓플레이스',
  ...
  {
    key: 'programming-languages', category: 'technology', label: '프로그래밍 언어',
  ...
  {
    key: 'board-games', category: 'games', label: '보드게임',
  ...
  {
    key: 'public-libraries', category: 'culture', label: '공공도서관',
