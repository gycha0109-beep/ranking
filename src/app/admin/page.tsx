...
import { AlertTriangle, BarChart3, Building2, ClipboardList, Database, FileSpreadsheet, Flag, FolderKanban, Megaphone, MessageSquare, Package, ShieldAlert, Tag, UserCog } from 'lucide-react'
...
export default async function AdminDashboardPage() {
  ...
  const menuItems = [
    ...
    { title: 'Product & Semantic Evidence', description: 'MEASURE-1 제품 사용 baseline과 IA-2D semantic-governance evidence를 분리된 authority로 조회합니다.', href: '/admin/measure', icon: BarChart3, capability: 'audit_view' },
    { title: 'Reviewed Equivalence Evidence', description: 'IA-2L finalized candidate decisions와 reviewed Alias equivalence assertions를 읽기 전용으로 검토합니다.', href: '/admin/measure/equivalence', icon: BarChart3, capability: 'audit_view' },
