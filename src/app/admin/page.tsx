...
export default async function AdminDashboardPage() {
  ...
  const menuItems = [
    ...
    { title: '제품 사용 Baseline', description: 'MEASURE-1 eligible usage, search quality, discovery source와 QA 제외 현황을 조회합니다.', href: '/admin/measure', icon: BarChart3, capability: 'audit_view' },
