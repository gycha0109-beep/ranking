...
assert(corpus.worldCount === 24, 'corpus must contain exactly 24 content worlds')
assert(corpus.rankings.length >= 160 && corpus.rankings.length <= 260, 'corpus size must remain in the predeclared broad range')
