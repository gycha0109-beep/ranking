...
expectContains(globals, '.rw-comment-shell #comments-heading { color: #303640 !important; }', 'comment heading must be dark on the UI-1 light surface')
expectContains(globals, '.rw-comment-shell', 'comment compatibility scope missing')
